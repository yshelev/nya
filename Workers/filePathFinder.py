class FileFinder:
	...
	def get_file_from_data_files(self, filename: str) -> str:
		"""
		returns path to file located in 'DataFiles' directory with filename
		:param filename:
		:return:
		"""
		return self.ASSETS + self.DATAFILES + filename
